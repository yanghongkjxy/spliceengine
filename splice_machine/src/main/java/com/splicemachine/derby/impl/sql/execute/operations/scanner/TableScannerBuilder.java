...
public class TableScannerBuilder implements Externalizable{
    ...
    private TypeProvider keyTypeProvider;
    private SerializerMap serializerMap;

    public TableScannerBuilder keyTypes(TypeProvider typeProvider){
        this.keyTypeProvider=typeProvider;
        return this;
    }

    public TableScannerBuilder serializerMap(SerializerMap typeProvider){
        this.serializerMap=typeProvider;
        return this;
    }
...
//				return this;
    ...
    public SITableScanner build(){
        if(keyTypeProvider==null)
            keyTypeProvider=VersionedSerializers.typesForVersion(tableVersion);
        return new SITableScanner(SIFactoryDriver.siFactory.getDataLib(),scanner,
                ...
                indexName,
                tableVersion,
                filterFactory,keyTypeProvider,serializerMap);
