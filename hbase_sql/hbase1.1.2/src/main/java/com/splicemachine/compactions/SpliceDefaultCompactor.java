...
//    @Override
    public List<Path> compact(CompactionRequest request,CompactionThroughputController throughputController) throws IOException{
        return compact(request,throughputController,null);
    }
    ...
    public List<Path> compact(CompactionRequest request, CompactionThroughputController throughputController,User user) throws IOException {
        if(!allowSpark)
            return defaultCompact(request, throughputController,user);
    ...
    protected InternalScanner postCreateCoprocScanner(final CompactionRequest request,
                                                      ScanType scanType, InternalScanner scanner,User user) throws IOException {
...
//                        }
    ...
    private List<Path> defaultCompact(final CompactionRequest request,
                              CompactionThroughputController throughputController,User user) throws IOException {
    /*
     * Do a minor/major compaction on an explicit set of storefiles from a Store.
     * This is copied from HDP2.4.2 version of DefaultCompactor, in order to avoid
