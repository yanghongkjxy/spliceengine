...
public class DDLCoordinationTest{
    ...
    public void refreshNotifyAfterTimeout() throws Exception{
        ...
        try{
            ...
            Assert.assertEquals("Incorrect error state thrown!",ErrorState.DDL_TIMEOUT.getSqlState(),se.getSQLState());
        }
    ...
    private DDLWatchRefresher getRefresher(Clock clock,List<DDLChange> changes,final TestDDLCommunicator ddlCommunicator){
        ...
        return new DDLWatchRefresher(refreshChecker,clock,10l);
    }
