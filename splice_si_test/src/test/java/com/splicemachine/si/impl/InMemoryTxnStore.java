...
public class InMemoryTxnStore implements TxnStore{
    ...
    private TxnLifecycleObserver tcObserver;
    ...
    public void elevateTransaction(Txn txn,byte[] newDestinationTable) throws IOException{
        ...
        wl.lock();
        try{
            Txn writableTxnCopy=new WritableTxn(txn,tc,tcObserver,newDestinationTable);
    ...
    public void setLifecycleObserver(TxnLifecycleObserver lifecycleObserver){
        this.tcObserver = lifecycleObserver;
    }
