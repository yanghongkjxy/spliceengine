...
public class WritableTxn extends AbstractTxn{
    ...
    public WritableTxn(long txnId,
                       ...
                       boolean isAdditive){
        this(txnId,beginTimestamp,isolationLevel,parentTxn,tc,tcObserver,isAdditive,null);
    }
    ...
    public WritableTxn(Txn txn,TxnLifecycleManager tc,TxnLifecycleObserver tcObserver,byte[] destinationTable){
        super(txn.getTxnId(),txn.getBeginTimestamp(),txn.getIsolationLevel(),tcObserver);
